#
#  Be sure to run `pod spec lint OptionButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "OptionButton"
  s.version      = "0.0.1"
  s.summary      = "IBDesignable option button that have vertical stacked title and option labels for iOS and tvOS."
...
* You could set the content insets from either storyboard or code by `leftInset`, `rightInset`, `topInset` and `bottomInset` properties.
  ...
  s.homepage     = "https://github.com/cemolcay/OptionButton"
  ...
  s.source       = { :git => "https://github.com/cemolcay/OptionButton.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "OptionButton/OptionButton.swift"
